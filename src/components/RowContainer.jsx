  ...
  return (
    ...
    >
        ...
        {data && data.length > 0 ? data.map((item) => (
          <div 
          key={item.id}
          className='w-275 h-[175px] min-w-[300px] md:w-340 md:min-w-[340px]  my-12 bg-cardOverlay rounded-lg p-2 
          ...
          >
            ...
            <img src={NotFound} alt='' className='h-300 flex items-center justify-center'/>
            <p className=''>Items Not Available</p>
          </div>}
